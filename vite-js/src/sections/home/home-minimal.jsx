...
export function HomeMinimal({ sx, ...other }) {
  ...
  const renderDescription = (
    <>
      <SectionTitle
        txtGradient="کلیک"
		title="از تصویر تا تشخیص: همه‌چیز با یک"
      ...
      >
        {ITEMS.map((item) => (
          <Box
            ...
            display="flex"
          >
            <SvgColor src={item.icon} sx={{ width: 40, height: 40, opacity: 0.7 }} />
            <Stack spacing={1}>
...
const ITEMS = [
  {
    ...
    title: 'بیس AI',
    description: 'تشخیص سریع و دقیق نقاط اسکلتی و دندانی با الگوریتم‌های هوش‌مصنوعی',
  },
  {
    icon: `${CONFIG.site.basePath}/assets/icons/home/ic-design.svg`,
    title: 'محاسبه کامل آنالیزها',
    description: 'پشتیبانی از آنالیزهای معروف مانند Steiner، Ricketts، McNamara، Jarabak، Sassouni، Tweed',
  },
  {
    icon: `${CONFIG.site.basePath}/assets/icons/home/ic-development.svg`,
    title: 'گزارش حرفه‌ای',
    description: 'شامل زوایا، فواصل، تفسیر اولیه و نمودارهای مقایسه‌ای',
  },
];
