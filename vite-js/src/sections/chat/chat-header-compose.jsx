  ...
  return (
    <>
      ...
      <Autocomplete
        ...
        renderInput={(params) => <TextField {...params} placeholder="+ مخاطبین" />}
        renderOption={(props, recipient, { selected }) => (
          <li {...props} key={recipient.id}>
            ...
            >
              <Avatar alt={recipient.name} src={getAvatarUrl(recipient.avatarUrl)} sx={{ width: 1, height: 1 }} />
              <Stack
                alignItems="center"
        ...
        renderTags={(selected, getTagProps) =>
          selected.map((recipient, index) => (
            <Chip
              ...
              avatar={<Avatar alt={recipient.name} src={getAvatarUrl(recipient.avatarUrl)} />}
              size="small"
              variant="soft"
            />
          ))
