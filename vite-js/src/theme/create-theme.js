...
export function createTheme(localeComponents, settings) {
  const selectedFont = setFont(settings.fontFamily);
  ...
  const initialTheme = {
    ...
    typography: {
      ...
      fontSecondaryFamily: selectedFont, // Use selected font instead of Barlow
      // Override h1, h2, h3 to use selected font instead of Barlow
      h1: {
        ...typography.h1,
        fontFamily: selectedFont,
      },
